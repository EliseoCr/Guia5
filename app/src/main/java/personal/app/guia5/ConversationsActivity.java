...
import personal.app.guia5.adapters.ConversationsAdapter;
import personal.app.guia5.models.ConversationModel;
...
public class ConversationsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listConversations.add(new ConversationModel(R.drawable.user, "David Garcia", "Hello world!", "Yesterday"));
    }
